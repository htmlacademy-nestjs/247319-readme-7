...
import { CreateUserDto, LoggedUserRdo, LoginUserDto, UpdatePasswordDto, UserRdo } from '../index';
...
export class AuthenticationController {
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: AuthenticationResponseMessage.LogoutSuccess,
  })
  @ApiResponse({
    status: HttpStatus.UNAUTHORIZED,
    description: AuthenticationResponseMessage.AuthDoesNotExist,
  })
  @Post('logout')
  public async logout() {
